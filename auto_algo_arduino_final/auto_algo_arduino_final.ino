...
//this is used to switch mode of the sensor
int counter = 0; //initialize counter with zero
...
void loop() {
  ...
  delay(1000);  // Delay to allow the data to be visible
...
// delay(1000);
  ...
  //  Serial.println("1");
    if (command == "pump_on") {
      ...
      Serial.println("count_1");
    } else if (command == "solenoid1_on") {
      digitalWrite(SOLENOID1_PIN, LOW); // Open solenoid valve 
      Serial.println("count_1");
    } else if (command == "solenoid1_off") {
      digitalWrite(SOLENOID1_PIN, HIGH); // Close solenoid valve
      Serial.println("count_1");
    } else if (command == "solenoid2_on") {
      digitalWrite(SOLENOID2_PIN, LOW); // Open solenoid valve 
      Serial.println("count_1");
    } else if (command == "solenoid2_off") {
      digitalWrite(SOLENOID2_PIN, HIGH); // Close solenoid valve 
      Serial.println("count_1");
    } else if (command == "solenoid3_on") {
      digitalWrite(SOLENOID3_PIN, LOW); // Open solenoid valve 
      Serial.println("count_1");
    } else if (command == "solenoid3_off") {
      digitalWrite(SOLENOID3_PIN, HIGH); // Close solenoid valve 
      Serial.println("count_1");
    }
    else if(command == "switch_to_auto"){ 
      counter = 0;
      Serial.println("count is zero! switch to auto mode");
       Serial.println("count_0");
    }
    else if(command == "switch_to_manual"){
        counter = 1;
        Serial.println("count_1");
    Serial.println("count is one! switch to manual mode");
    } 
  }
}